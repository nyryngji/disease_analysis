...
from disease_analyis import analysis,analysis2
from disease_prophet import predict

def main():

    with st.sidebar:
        selected = option_menu('감염병 분석',['MAIN','질병 관련 소개','지역별 감염 현황','확진자 수 예측','감염병 확진자 수 비율'],
    ...
    if selected == 'MAIN':
        ...
        st.markdown('<br><b>데이터 출처</b> : <br> - 감염병포털 : https://dportal.kdca.go.kr/pot/index.do <br> - KOSIS : https://kosis.kr/statHtml/statHtml.do?orgId=101&tblId=DT_1B040A3',unsafe_allow_html=True)
